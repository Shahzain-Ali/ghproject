...
const About = () => {
      ...
      <section className='py-16'>
            <div className='flex customsm:flex-col customsm:w-auto  w-[70%] mx-auto gap-x-6  justify-center'>
                <div className='w-[300px] h-[290px] customsm:mx-auto'>
                    <Image src="/Group 73.png" alt="" width={50} height={50} className='w-[300px] h-[250px] smm:h-[200px]' />
                </div>
  ...
  >
    <Image 
      src={item.img} 
      alt={item.title} 
      width={500}  // Image ki width specify karo
      height={300} // Image ki height specify karo
    />
    ...
    <p className="text-[14px] text-[#a4a3a3] leading-5">
      ...
      <section className='bg-[#FBFBFF] w-full py-7 my-7'>
            ...
            <div className='w-[50%]  mx-auto mt-2 '>
                <Image src="/Comments_and_ images.png" alt="" width={50} height={50} className='w-[400px] h-[200px] mx-auto'/>
            </div>
      </section>
    </div>
  )
