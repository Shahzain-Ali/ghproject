    ...
    <div>
        ...
        <section>
            ...
            <div className='flex justify-between w-[80%] mx-auto py-3' >
                <div className='w-[50%]  '>
                    <Image src="/Rectangle_32.png" alt="" width={500} height={400}  className='mx-auto' />
                </div>
                <div className='w-[50%]  flex flex-col gap-3  pt-5'>
                    ...
                    <div className='flex place-items-center gap-x-4'>
                        ...
                        <Image src="/Group_236.png" alt="" width={500} height={400}  className='w-[50px] h-[16px] '/>
                    </div>
            ...
            <div className='flex justify-between w-[80%] mx-auto py-3' >
                <div className='w-[50%]  '>
                    <Image src="/Rectangle_32 (1).png" alt="" width={500} height={400}  className='mx-auto' />
                </div>
                <div className='w-[50%]  flex flex-col gap-3  pt-5'>
                    <div className='flex place-items-center gap-x-4'>
                        <h1 className='text-[14px] font-semibold text-[#111C85]'>Accumsan tincidunt</h1>
            ...
            <div className='flex justify-between w-[80%] mx-auto py-3' >
                <div className='w-[50%]  '>
                    <Image src="/Rectangle_32 (2).png" alt="" width={500} height={400} className='mx-auto' />
                </div>
                <div className='w-[50%]  flex flex-col gap-3  pt-5'>
                    <div className='flex place-items-center gap-x-4'>
                        <h1 className='text-[14px] font-semibold text-[#111C85]'>Accumsan tincidunt</h1>
            ...
            <div className='flex justify-between w-[80%] mx-auto py-3' >
                <div className='w-[50%]  '>
                    <Image src="/Rectangle_32 (3).png" alt="" width={500} height={400}  className='mx-auto' />
                </div>
                <div className='w-[50%]  flex flex-col gap-3  pt-5'>
                    <div className='flex place-items-center gap-x-4'>
                        <h1 className='text-[14px] font-semibold text-[#111C85]'>Accumsan tincidunt</h1>
            ...
            <div className='flex justify-between w-[80%] mx-auto py-3' >
                <div className='w-[50%]  '>
                    <Image src="/Rectangle_32 (4).png" alt="" width={500} height={400}  className='mx-auto' />
                </div>
                <div className='w-[50%]  flex flex-col gap-3  pt-5'>
                    <div className='flex place-items-center gap-x-4'>
                        <h1 className='text-[14px] font-semibold text-[#111C85]'>Accumsan tincidunt</h1>
            ...
            <div className='flex justify-between w-[80%] mx-auto py-3' >
                <div className='w-[50%]  '>
                    <Image src="/Rectangle_32 (5).png" alt="" width={500} height={400}  className='mx-auto' />
                </div>
                <div className='w-[50%]  flex flex-col gap-3  pt-5'>
                    <div className='flex place-items-center gap-x-4'>
                        <h1 className='text-[14px] font-semibold text-[#111C85]'>Accumsan tincidunt</h1>
            ...
            <div className='flex justify-between w-[80%] mx-auto py-3' >
                <div className='w-[50%]  '>
                    <Image src="/Rectangle_32 (6).png" alt="" width={500} height={400}  className='mx-auto' />
                </div>
                <div className='w-[50%]  flex flex-col gap-3  pt-5'>
                    <div className='flex place-items-center gap-x-4'>
                        <h1 className='text-[14px] font-semibold text-[#111C85]'>Accumsan tincidunt</h1>
