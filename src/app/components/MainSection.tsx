      ...
      <section className="relative py-10 md:py-10 px-5 flex flex-col customsm:flex-col md:flex-row lg:flex-row sm:flex-col items-center justify-between overflow-hidden w-[100%] mx-auto">
        ...
        <div className="flex justify-between customsm:flex-col w-[80%] ml-auto mr-10 sm:w-full sm:order-2 sm:text-center">
          ...
          <div className="md:w-1/3 lg:w-1/3 max-w-lg text-center md:text-left lg:text-left flex flex-col justify-center sm:w-full">
            <p className="text-sm text-pink-500 font-medium">{t("bestFurniture")}</p>
          ...
          <div className="md:w-1/3 lg:w-1/3 smm:w-[40%] smm:h-[400px] flex justify-center items-center relative">
            {/* Background Image with Rotation */}
            <div
              className="absolute h-[22rem] smm:h-[13rem] smm:w-[140px] smm:ml-[-10px] smm:inset-8 inset-0 bg-cover bg-center rounded-full md:rotate-45 sm:rotate-45 transform rotate-45 smm:rotate-5 mt-12 smm:mt-8"
              style={{ backgroundImage: `url('/Group_129.png')` }}
            ></div>

            {/* Discount Tag */}
            <div className="absolute smm:mr-[-20px] top-[48px] right-[1.25rem] sm:[48px] sm:right-5 md:top-[48px] md:right-[0rem] lg:top-[32px] lg:right-[0rem] z-20">
            ...
            <div className="relative z-10 bg-gradient-to-r rounded-full p-10 smm:p-0 smm:mt-0 mt-10 smm:pt-0 ">
              <div className="relative w-[18rem] h-[18rem] smm:w-[12rem] smm:h-[12rem] smm:mr-[-50px]">
