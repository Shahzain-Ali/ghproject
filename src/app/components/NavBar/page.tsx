      ...
      <div className="w-full flex items-center justify-center bg-[#F6F5FF] h-[70px]">
        <div className="sm:w-full md:w-[89%] lg:w-[89%] flex items-center justify-between h-[50px] px-4 relative">
          ...
          <div
            ...
            } md:flex md:translate-x-0 md:static w-[50%] border-2  md:w-auto bg-white/90 md:bg-transparent absolute top-0 left-[-58px] smm:left-[-140px] smm:w-[60%] smm:text-right customsm:text-center sm:text-center lg:text-center h-screen md:h-auto z-40Add transition-transform duration-500 ease-in-out`}
          >
